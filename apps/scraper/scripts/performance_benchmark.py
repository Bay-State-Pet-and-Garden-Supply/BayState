...
async def main():
    if not os.environ.get("OPENAI_API_KEY") or not os.environ.get("BRAVE_API_KEY"):
        logger.error("Missing API keys (OPENAI_API_KEY, BRAVE_API_KEY). Cannot run real benchmark.")
