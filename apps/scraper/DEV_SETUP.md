...
BayStateScraper is a distributed Python scraping engine that executes API-published scraper workflows via Playwright. Stateless runners communicate with the BayStateApp coordinator via API.
...
### Configuration (Published API Config)

Scrapers are loaded from the BayStateApp Scraper Config API and follow this structure:
