# AI Scraper Documentation (LEGACY - DEPRECATED)
...
**WARNING**: This documentation is for the legacy browser-use AI scraping system. It has been replaced by crawl4ai in v0.3.0. Please refer to the migration guide to update your scrapers.
