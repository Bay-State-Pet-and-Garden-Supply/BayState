# AI Scraper Documentation (DEPRECATED)

**Status**: DEPRECATED as of v0.3.0  
**Replacement**: [crawl4ai Configuration Guide](crawl4ai-config.md)  
**Migration Guide**: [Migration Guide](migration-guide.md)

---

**WARNING**: This documentation is for the legacy browser-use AI scraping system. It has been replaced by crawl4ai in v0.3.0.

**New users**: Please see [crawl4ai Configuration Guide](crawl4ai-config.md) for current documentation.  
**Existing users**: See [Migration Guide](migration-guide.md) to upgrade your scrapers.

---

> **Note**: This documentation describes the deprecated AI Agent Scraper system. The code has been archived and is no longer maintained.
...
> ⚠️ **All AI handler files have been archived** - see `scraper_backend/archive/ai_handlers/`

| File | Purpose |
|------|---------|
| `scraper_backend/archive/ai_handlers/ai_base.py` | Archived: Base class for AI actions |
| `scraper_backend/archive/ai_handlers/ai_extract.py` | Archived: AI extraction action |
| `scraper_backend/archive/ai_handlers/ai_search.py` | Archived: AI search action |
| `scraper_backend/archive/ai_handlers/ai_validate.py` | Archived: AI validation action |
