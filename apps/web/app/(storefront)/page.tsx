      ...
      {(!heroSlides || heroSlides.length === 0) && (
        <section className="mb-12 bg-primary text-white py-16 text-center shadow-md">
          <div className="container mx-auto px-4">
            ...
            <Button size="lg" className="bg-accent text-secondary hover:bg-accent/90 text-lg font-bold px-8 py-6 rounded-none shadow-lg border-b-4 border-black/20" asChild>
      ...
      <div className="container mx-auto px-4">
        ...
        <section className="mb-16">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <Link href="/products?category=pet-supplies" className="group border-4 border-zinc-900 bg-primary h-[300px] transition-all hover:-translate-x-1 hover:-translate-y-1 shadow-[12px_12px_0px_rgba(0,0,0,1)] hover:shadow-[16px_16px_0px_rgba(0,0,0,1)] relative overflow-hidden">
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 bg-primary group-hover:bg-primary/95 transition-colors">
                ...
                <div className="h-2 w-24 bg-accent mt-2 shadow-[4px_4px_0px_rgba(0,0,0,0.2)]"></div>
                <span className="mt-8 text-white/80 font-bold uppercase tracking-[0.2em] text-xs">Explore Department →</span>
              </div>
            </Link>

            <Link href="/products?category=farm" className="group border-4 border-zinc-900 bg-red-600 h-[300px] transition-all hover:-translate-x-1 hover:-translate-y-1 shadow-[12px_12px_0px_rgba(0,0,0,1)] hover:shadow-[16px_16px_0px_rgba(0,0,0,1)] relative overflow-hidden">
            ...
            <Link href="/products?category=lawn-garden" className="group border-4 border-zinc-900 bg-green-600 h-[300px] transition-all hover:-translate-x-1 hover:-translate-y-1 shadow-[12px_12px_0px_rgba(0,0,0,1)] hover:shadow-[16px_16px_0px_rgba(0,0,0,1)] relative overflow-hidden">
            ...
            <Link href="/products?category=home" className="group border-4 border-zinc-900 bg-blue-600 h-[300px] transition-all hover:-translate-x-1 hover:-translate-y-1 shadow-[12px_12px_0px_rgba(0,0,0,1)] hover:shadow-[16px_16px_0px_rgba(0,0,0,1)] relative overflow-hidden">
            ...
            <Link href="/products?category=seasonal" className="group border-4 border-zinc-900 bg-orange-600 h-[300px] transition-all hover:-translate-x-1 hover:-translate-y-1 shadow-[12px_12px_0px_rgba(0,0,0,1)] hover:shadow-[16px_16px_0px_rgba(0,0,0,1)] relative overflow-hidden">
