        ...
        <div className="space-y-12">
            ...
            {orders.length === 0 ? (
                ...
                <div className="grid gap-8">
                    {orders.map((order) => (
                        <div key={order.id} className="border-4 border-zinc-900 bg-white shadow-[8px_8px_0px_rgba(220,38,38,1)] overflow-hidden">
                            <div className="bg-red-600 p-4 border-b-4 border-zinc-900 flex flex-col sm:flex-row sm:items-center justify-between text-white gap-4">
                                ...
                                <div className="flex items-center gap-6">
                                    ...
                                    <StatusBadge status={order.status} className="border-2 border-white/20 bg-white/10 text-white font-black uppercase text-[10px]" />
                                </div>
                            </div>
                            <div className="p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                                ...
                                <Button asChild variant="outline" className="w-full sm:w-auto border-2 border-zinc-900 rounded-none font-black uppercase tracking-tight hover:bg-zinc-100">
