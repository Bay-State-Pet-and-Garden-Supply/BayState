...
export default async function ScraperWorkbenchLayout({
 ...
 <Button variant="ghost" size="sm" asChild className="-ml-2 h-8 w-8 p-0 rounded-none border border-transparent hover:border-border">
 ...
 <div className="flex items-center text-zinc-600 text-[10px] font-bold uppercase gap-4">
