...
export function RunnerCard({
 ...
 <Button variant="ghost" size="icon-sm" className="h-7 w-7 border-2 border-border">
 ...
 {/* Footer Actions */}
 <div className="flex justify-between items-center mt-auto pt-3 border-t-2 border-border/10">
 ...
 disabled={isToggling}
 className="data-[state=checked]:bg-brand-forest-green border-2 border-border"
 />
 <Label 
 ...
 <Badge variant="warning" className="animate-pulse border-2 border-border">
