...
export function ScraperCredentialsCard({ slug }: ScraperCredentialsCardProps) {
 ...
 return (
 <div key={type} className="space-y-3 p-4 rounded-none border border-border bg-muted/5">
 ...
 className="flex-1 rounded-none border-zinc-300 focus:border-border focus:ring-0"
