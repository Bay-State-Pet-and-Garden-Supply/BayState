...
export function UnderConstructionBanner() {
  return (
    <div className="bg-accent text-accent-foreground border-b-4 border-zinc-900 py-1.5 px-4 relative z-30">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-center gap-3 text-center">
        <div className="flex items-center gap-2 font-display font-semibold text-sm md:text-base">
        ...
        <a
          ...
          className="flex items-center gap-1.5 bg-secondary text-secondary-foreground px-4 py-1.5 text-xs font-semibold border border-zinc-200 rounded-lg shadow-sm hover:-translate-y-1 hover:shadow-sm transition-all shrink-0"
        >
