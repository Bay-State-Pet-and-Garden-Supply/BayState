...
VALUES
  -- Animal Type
  ('v0000000-0000-0000-0001-000000000001', 'f0000000-0000-0000-0000-000000000001', 'Dog', 'dog', 'dog'),
  ('v0000000-0000-0000-0001-000000000002', 'f0000000-0000-0000-0000-000000000001', 'Cat', 'cat', 'cat'),
  ('v0000000-0000-0000-0001-000000000003', 'f0000000-0000-0000-0000-000000000001', 'Small Pet', 'small-pet', 'small-pet'),
  -- Life Stage
  ('v0000000-0000-0000-0002-000000000001', 'f0000000-0000-0000-0000-000000000002', 'Adult', 'adult', 'adult'),
  ('v0000000-0000-0000-0002-000000000002', 'f0000000-0000-0000-0000-000000000002', 'Puppy', 'puppy', 'puppy'),
  ('v0000000-0000-0000-0002-000000000003', 'f0000000-0000-0000-0000-000000000002', 'Kitten', 'kitten', 'kitten'),
  ('v0000000-0000-0000-0002-000000000004', 'f0000000-0000-0000-0000-000000000002', 'All Life Stages', 'all-life-stages', 'all-life-stages'),
  -- Primary Protein
  ('v0000000-0000-0000-0003-000000000001', 'f0000000-0000-0000-0000-000000000003', 'Salmon', 'salmon', 'salmon'),
  ('v0000000-0000-0000-0003-000000000002', 'f0000000-0000-0000-0000-000000000003', 'Chicken', 'chicken', 'chicken'),
  ('v0000000-0000-0000-0003-000000000003', 'f0000000-0000-0000-0000-000000000003', 'Game Bird', 'game-bird', 'game-bird'),
  ('v0000000-0000-0000-0003-000000000004', 'f0000000-0000-0000-0000-000000000003', 'Grain', 'grain', 'grain'),
  -- Food Form
  ('v0000000-0000-0000-0004-000000000001', 'f0000000-0000-0000-0000-000000000004', 'Dry Kibble', 'dry-kibble', 'dry-kibble'),
  ('v0000000-0000-0000-0004-000000000002', 'f0000000-0000-0000-0000-000000000004', 'Treat', 'treat', 'treat'),
  ('v0000000-0000-0000-0004-000000000003', 'f0000000-0000-0000-0000-000000000004', 'Litter', 'litter', 'litter'),
  -- Package Weight (for search only)
  ('v0000000-0000-0000-0005-000000000001', 'f0000000-0000-0000-0000-000000000005', '30 lb', '30-lb', '30-lb'),
  ('v0000000-0000-0000-0005-000000000002', 'f0000000-0000-0000-0000-000000000005', '24 lb', '24-lb', '24-lb'),
  ('v0000000-0000-0000-0005-000000000003', 'f0000000-0000-0000-0000-000000000005', '18 lb', '18-lb', '18-lb'),
  ('v0000000-0000-0000-0005-000000000004', 'f0000000-0000-0000-0000-000000000005', '15 lb', '15-lb', '15-lb'),
  ('v0000000-0000-0000-0005-000000000005', 'f0000000-0000-0000-0000-000000000005', '10 lb', '10-lb', '10-lb'),
  ('v0000000-0000-0000-0005-000000000006', 'f0000000-0000-0000-0000-000000000005', '7 lb', '7-lb', '7-lb')
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ...
  ('d0000000-0000-0000-0000-000000000001', 'v0000000-0000-0000-0002-000000000001'),
  ('d0000000-0000-0000-0000-000000000001', 'v0000000-0000-0000-0003-000000000002'),
  ('d0000000-0000-0000-0000-000000000001', 'v0000000-0000-0000-0004-000000000001'),
  ('d0000000-0000-0000-0000-000000000001', 'v0000000-0000-0000-0005-000000000001'),
  -- Fromm Puppy Gold -> Puppy, Chicken, Dry Kibble, 15 lb
  ('d0000000-0000-0000-0000-000000000002', 'v0000000-0000-0000-0002-000000000002'),
  ('d0000000-0000-0000-0000-000000000002', 'v0000000-0000-0000-0003-000000000002'),
  ('d0000000-0000-0000-0000-000000000002', 'v0000000-0000-0000-0004-000000000001'),
  ('d0000000-0000-0000-0000-000000000002', 'v0000000-0000-0000-0005-000000000004'),
  -- Purina Pro Plan Sensitive -> Adult, Salmon, Dry Kibble, 24 lb
  ('d0000000-0000-0000-0000-000000000003', 'v0000000-0000-0000-0002-000000000001'),
  ('d0000000-0000-0000-0000-000000000003', 'v0000000-0000-0000-0003-000000000001'),
  ('d0000000-0000-0000-0000-000000000003', 'v0000000-0000-0000-0004-000000000001'),
  ('d0000000-0000-0000-0000-000000000003', 'v0000000-0000-0000-0005-000000000002'),
  -- Purina Pro Plan Complete Essentials -> Adult, Chicken, Dry Kibble, 18 lb
  ('d0000000-0000-0000-0000-000000000004', 'v0000000-0000-0000-0002-000000000001'),
  ('d0000000-0000-0000-0000-000000000004', 'v0000000-0000-0000-0003-000000000002'),
  ('d0000000-0000-0000-0000-000000000004', 'v0000000-0000-0000-0004-000000000001'),
  ('d0000000-0000-0000-0000-000000000004', 'v0000000-0000-0000-0005-000000000003'),
  -- KONG Classic -> Dog, All Life Stages, Toy
  ('d0000000-0000-0000-0000-000000000005', 'v0000000-0000-0000-0002-000000000004'),
  ('d0000000-0000-0000-0000-000000000005', 'v0000000-0000-0000-0004-000000000002'),
  -- KONG Easy Treat -> Dog, Treat
  ('d0000000-0000-0000-0000-000000000006', 'v0000000-0000-0000-0004-000000000002'),
  -- Fromm Cat Food -> Cat, Adult, Game Bird, Dry Kibble, 10 lb
  ('d0000000-0000-0000-0000-000000000007', 'v0000000-0000-0000-0001-000000000002'),
  ('d0000000-0000-0000-0000-000000000007', 'v0000000-0000-0000-0002-000000000001'),
  ('d0000000-0000-0000-0000-000000000007', 'v0000000-0000-0000-0003-000000000003'),
  ('d0000000-0000-0000-0000-000000000007', 'v0000000-0000-0000-0004-000000000001'),
  ('d0000000-0000-0000-0000-000000000007', 'v0000000-0000-0000-0005-000000000005'),
  -- Purina Kitten -> Cat, Kitten, Chicken, Dry Kibble, 7 lb
  ('d0000000-0000-0000-0000-000000000008', 'v0000000-0000-0000-0001-000000000002'),
  ('d0000000-0000-0000-0000-000000000008', 'v0000000-0000-0000-0002-000000000003'),
  ('d0000000-0000-0000-0000-000000000008', 'v0000000-0000-0000-0003-000000000002'),
  ('d0000000-0000-0000-0000-000000000008', 'v0000000-0000-0000-0004-000000000001'),
  ('d0000000-0000-0000-0000-000000000008', 'v0000000-0000-0000-0005-000000000006'),
  -- World's Best Cat Litter -> Cat, Litter
  ('d0000000-0000-0000-0000-000000000009', 'v0000000-0000-0000-0001-000000000002'),
  ('d0000000-0000-0000-0000-000000000009', 'v0000000-0000-0000-0004-000000000003'),
  -- Jonathan Green Grass Seed -> Grain
  ('d0000000-0000-0000-0000-000000000010', 'v0000000-0000-0000-0003-000000000004'),
  -- Jonathan Green Lawn Food -> Grain
  ('d0000000-0000-0000-0000-000000000011', 'v0000000-0000-0000-0003-000000000004'),
  -- Kaytee Timothy Hay -> Small Pet
  ('d0000000-0000-0000-0000-000000000012', 'v0000000-0000-0000-0001-000000000003')
ON CONFLICT DO NOTHING;
...
VALUES
  ('s0000000-0000-0000-0000-000000000001', 'campaign_banner', '{"text": "Local seed data — not production", "variant": "info", "active": false}'::jsonb),
  ('s0000000-0000-0000-0000-000000000002', 'homepage', '{"hero_title": "Bay State Pet & Garden Supply (DEV)", "hero_subtitle": "Local development instance", "featured_category_ids": ["c0000000-0000-0000-0000-000000000001", "c0000000-0000-0000-0000-000000000004"]}'::jsonb),
  ('s0000000-0000-0000-0000-000000000003', 'navigation', '{"primary": [{"label": "Shop", "href": "/products"}, {"label": "Services", "href": "/services"}], "secondary": []}'::jsonb),
  ('s0000000-0000-0000-0000-000000000004', 'branding', '{"store_name": "Bay State Pet & Garden Supply (DEV)", "logo_url": null}'::jsonb),
  ('s0000000-0000-0000-0000-000000000005', 'shopsite_migration', '{"active": false, "merchant": "", "password": "", "url": "https://placeholder.local/shop"}'::jsonb)
