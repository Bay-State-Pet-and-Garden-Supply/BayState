...
export function ScraperTabsClient({ slug }: ScraperTabsClientProps) {
  ...
  return (
    <Tabs value={tabSegment} className="w-full mt-6">
      <div className="overflow-x-auto pb-2 -mb-2">
        <TabsList className="inline-flex h-11 w-max min-w-full justify-start rounded-md bg-muted p-1 text-muted-foreground">
          <TabsTrigger value="overview" asChild className="min-w-[120px] h-9">
            <Link href={`/admin/scrapers/${slug}`}>
          ...
          <TabsTrigger value="history" asChild className="min-w-[120px] h-9">
            <Link href={`/admin/scrapers/${slug}/history`}>
