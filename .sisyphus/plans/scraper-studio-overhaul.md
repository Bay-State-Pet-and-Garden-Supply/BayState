...
### Definition of Done
- [ ] `/admin/scrapers/studio` fully functional with all features
- [ ] Legacy `/lab` and `/test-lab` redirect to `/studio`
- [ ] All acceptance criteria pass for each TODO
- [ ] Runner events v2 emitting correctly with backward compat
- [ ] Real-time updates working for test runs
- [ ] Health dashboard showing trends and metrics
- [ ] Config editing with version history functional
- [ ] All TODO QA scenarios pass
...
- [ ] **13. Selector Validation Display**
...
### Final Checklist
- [ ] All 17 TODOs completed with passing QA
- [ ] `/admin/scrapers/studio` fully functional
- [ ] Legacy routes redirect to studio
- [ ] Real-time timeline working
- [ ] Config editing with versions working
- [ ] Health dashboard showing data
- [ ] Runner emitting v2 events
- [ ] All tests passing
