...
### Definition of Done
- [x] All legacy routes redirect correctly (301/302 with query params preserved)
- [x] ConfigEditorClient all 7 tabs function identically
- [x] ConfigsClient list view shows all configs
- [x] Draft/Validate/Publish workflow completes successfully
- [x] TestLabClient loads without errors
- [x] SKU Manager creates/updates/deletes SKUs
- [x] Real-time results display within 2 seconds
- [x] HistoricalTestRuns shows previous runs
- [x] TestAnalyticsDashboard renders all charts
...
- [x] 1. **Create rollback checklist and backup strategy**
  ...
  **Acceptance Criteria**:
  - [x] Rollback checklist created at `.sisyphus/plans/scraper-lab-rollback.md`
  - [x] All modified files documented with original state captured
  - [x] Git commit created before any modifications
...
- [x] 2. **Search for hardcoded URLs to old paths**
  ...
  **Acceptance Criteria**:
  - [x] Search completed and results documented
  - [x] All occurrences listed with file paths and line numbers
  - [x] Categorized by: Components, API routes, Documentation
...
- [x] 3. **Create new /admin/scraper-lab/ route structure**
  ...
  **Acceptance Criteria**:
  - [x] Directory `app/admin/scraper-lab/` created
  - [x] `page.tsx` renders without errors
  - [x] `[id]/page.tsx` renders without errors
  - [x] `new/page.tsx` renders without errors
  - [x] TypeScript build passes

- [x] 4. **Create unified ScraperLabLanding component**
  ...
  **Acceptance Criteria**:
  ...
  - [x] Config list displays all configs with status badges
  - [x] "Create New Config" button opens wizard
  - [x] "Run Tests" button navigates to test runner
  - [x] TypeScript build passes

- [x] 5. **Update sidebar navigation**
  ...
  **Acceptance Criteria**:
  - [x] Sidebar shows "Scraper Lab" instead of "Configs"
  - [x] "Test Lab" removed from sidebar
  - [x] Link points to `/admin/scraper-lab`
  - [x] TypeScript build passes

- [x] 6. **Create legacy route redirects (307)**
  ...
  **Acceptance Criteria**:
  - [x] `/admin/scrapers/configs/123` redirects to `/admin/scraper-lab/123`
  - [x] `/admin/scrapers/test-lab` redirects to `/admin/scraper-lab`
  - [x] Query parameters preserved in redirects
  - [x] TypeScript build passes

- [x] 7. **Migrate ConfigEditorClient to new location**
  ...
  **Acceptance Criteria**:
  - [x] ConfigEditorClient accessible at new location
  - [x] All 7 tabs render correctly
  - [x] Draft/Validate/Publish workflow completes successfully
  - [x] TypeScript build passes

- [x] 8. **Integrate TestLabClient with new landing**
  ...
  **Acceptance Criteria**:
  - [x] TestLabClient accessible from new landing
  - [x] Real-time updates display within 2 seconds
  - [x] SKU Manager creates/updates/deletes SKUs
  - [x] TypeScript build passes

- [x] 9. **Update component imports and links**
  ...
  **Acceptance Criteria**:
  - [x] All hardcoded URLs updated to new paths
  - [x] All component imports updated
  - [x] TypeScript build passes
  - [x] No console errors on page load

- [x] 10. **Verify all legacy routes redirect**
  ...
  **Acceptance Criteria**:
  - [x] All legacy routes return 301/302 status
  - [x] Location header contains correct new path
  - [x] Query parameters preserved
  - [x] Results documented

- [x] 11. **Verify feature parity (all tabs, workflows)**
  ...
  **Acceptance Criteria**:
  - [x] All 7 ConfigEditorClient tabs function
  - [x] Real-time updates display within 2 seconds
  - [x] SKU Manager CRUD operations work
  - [x] HistoricalTestRuns displays past runs
  - [x] TestAnalyticsDashboard renders all charts
  - [x] Draft/Validate/Publish workflow completes

- [x] 12. **Run TypeScript build**
...
- [x] All "Must NOT Have" absent (no schema changes, no API changes)
- [x] All tests pass
